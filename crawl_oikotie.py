...
if __name__ == '__main__':
   ...
   for house_id in id_list:
      try:
         ...
         failed_connection_list.append(house_id)
      except UnicodeDecodeError, e:
         failed_unicode_list.append(house_id)
      except IndexError, e:
         failed_index_list.append(house_id)
      finally:
         i = i + 1
      
   end = time.time()
   print "total time:", str(end - start)
   print "failed connection:", len(failed_connection_list)
   print "failed unicode:", len(failed_unicode_list)
   print "failed index:", len(failed_index_list)